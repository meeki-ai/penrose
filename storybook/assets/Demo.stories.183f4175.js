...
`,locationsMap:{"vector-examples":{startLoc:{col:46,line:18},endLoc:{col:1,line:22},startBody:{col:46,line:18},endBody:{col:1,line:22}}}}},title:"Example/Demo Component",component:p};const D=e=>r("div",{style:{width:"100%",height:"100%"},children:r(p,l({},e))}),w=D.bind({});w.args={examples:[{sub:s.substance,sty:s.style,dsl:s.domain,variation:s.variation},{sub:a.substance,sty:a.style,dsl:a.domain,variation:a.variation}],width:"400px"};const P=["VectorExamples"];export{w as VectorExamples,P as __namedExportsOrder,O as default};
//# sourceMappingURL=Demo.stories.183f4175.js.map
